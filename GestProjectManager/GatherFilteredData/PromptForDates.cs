...
{
    internal class PromptForDates
    {   
        public bool Error {  get; set; } = true;
        public int VariableHeight { get; set; } = EOStyles.Row1Top;

        public System.Windows.Forms.Form CurrentForm { get; set; } = new System.Windows.Forms.Form();
        ...
        {
            CurrentForm.Text = "Seleccione las fechas en las que desea sincronizar datos";
            ...
            CurrentForm.Controls.Add(AcceptDatesButton);
            CurrentForm.Controls.Add(ControlsPanel);
